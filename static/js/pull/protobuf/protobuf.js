...
(function(global, undefined) {
    ...
    (function prelude(modules, cache, entries) {
        ...
        function $require(name) {
            ...
            if (!$module)
                modules[name][0].call($module = cache[name] = {
                    exports: {}
            ...
            function genValuePartial_fromObject(gen, field, fieldIndex, prop) {
                ...
                if (field.resolvedType) {
                    if (field.resolvedType instanceof Enum) {
                        ...
                        gen
                            ("}");
                    } else gen("if(typeof d%s!==\"object\")", prop)
            ...
            converter.toObject = function toObject(mtype) {
                ...
                if (normalFields.length) {
                    ...
                    for (i = 0; i < normalFields.length; ++i) {
                        ...
                        else if (field.long) gen("if(util.Long){")
                ...
                for (i = 0; i < fields.length; ++i) {
                    ...
                    if (field.map) {
                        ...
                        if (field.partOf) gen("if(o.oneofs)")
        ...
        13: [function(require, module, exports) {
            ...
            function decoder(mtype) {
                ...
                var gen = util.codegen(["r", "l"], mtype.name + "$decode")
                    ...
                    ("r=Reader.create(r)")
                    ("var c=l===undefined?r.len:r.pos+l,m=new this.ctor" + (mtype.fieldsArray.filter(function(field) {
                        return field.map;
                    }).length ? ",k" : ""))
                    ("while(r.pos<c){")
                    ("var t=r.uint32()");
                if (mtype.group) gen("if((t&7)===4)")
                    ("break");
                gen
                    ("switch(t>>>3){");
                ...
                for (; i < /* initializes */ mtype.fieldsArray.length; ++i) {
                    ...
                    if (field.map) {
                        ...
                        if (types.packed[type] !== undefined) gen("if((t&7)===2){")
                ...
                for (i = 0; i < mtype._fieldsArray.length; ++i) {
                    ...
                    if (rfield.required) gen("if(!m.hasOwnProperty(%j))", rfield.name)
            ...
            Field.d = function decorateField(fieldId, fieldType, fieldRule, defaultValue) {
                ...
                return function fieldDecorator(prototype, fieldName) {
                    util.decorateType(prototype.constructor)
                        .add(new Field(fieldName, fieldId, fieldType, fieldRule, {
                ...
                for (var i = 0; i < /* initializes */ mtype.fieldsArray.length; ++i) {
                    ...
                    if (field.map) {
                        ...
                        if (field.partOf) {
                            ...
                            if (seenFirstField[field.partOf.name] === 1) gen("if(p%s===1)", oneofProp)
